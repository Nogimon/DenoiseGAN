...
if __name__ == "__main__":
    ...
    if (taskl == 'SRGAN'):
        ...
        Flags.DEFINE_string('output_dir', "./experiment_SRGAN_VGG54_ocm1/", 'The output directory of the checkpoint')
        Flags.DEFINE_string('summary_dir', "./experiment_SRGAN_VGG54_ocm1/log/", 'The dirctory to output the summary')
        Flags.DEFINE_string('mode', 'train', 'The mode of the model train, test.')
        Flags.DEFINE_string('checkpoint','./SRGAN_pre-trained/model-200000',"")#"./experiment_SRGAN_VGG54_try2/model-80000", 'If provided, the weight will be restored from the provided checkpoint')
        ...
        Flags.DEFINE_string('input_dir_LR', "./data/OCMTRY_LR/", 'The directory of the input resolution input data')
        Flags.DEFINE_string('input_dir_HR', "./data/OCMTRY_HR/", 'The directory of the high resolution input data')
        ...
        Flags.DEFINE_float('ratio', 0.001, 'The ratio between content loss and adversarial loss')
         ...
         # The system parameter
        Flags.DEFINE_string('output_dir', "./experiment_denoise/", 'The output directory of the checkpoint')
        Flags.DEFINE_string('summary_dir', "./experiment_denoise/log/", 'The dirctory to output the summary')
        Flags.DEFINE_string('mode', 'train', 'The mode of the model train, test.')
        Flags.DEFINE_string('checkpoint',None,"")#"./experiment_SRGAN_VGG54_try2/model-80000", 'If provided, the weight will be restored from the provided checkpoint')
        ...
        Flags.DEFINE_boolean('is_training', True, 'Training => True, Testing => False')
        Flags.DEFINE_string('vgg_ckpt', './vgg19/vgg_19.ckpt', 'path to checkpoint file for the vgg19')
        Flags.DEFINE_string('task', "denoise", 'The task: SRGAN, SRResnet')

        # The data preparing operation
        Flags.DEFINE_integer('batch_size', 16, 'Batch size of the input batch')
        Flags.DEFINE_string('input_dir_LR', "./data/DENOISE_LR/", 'The directory of the input resolution input data')
        Flags.DEFINE_string('input_dir_HR', "./data/DENOISE_HR/", 'The directory of the high resolution input data')
    ...
    Flags.DEFINE_integer('max_iter', 120000, 'The max iteration of the training')
    ...
    if (FLAGS.mode == 'train'):
        ...
        # Add scalar summary
        if (FLAGS.task == 'SRGAN' or FLAGS.task == 'denoise'):
        ...
        with sv.managed_session(config=config) as sess:
            ...
            print("saved weights at" + FLAGS.output_dir)
    ...
    if FLAGS.mode == 'test':
        ...
        with tf.variable_scope('generator'):
            if FLAGS.task == 'SRGAN' or FLAGS.task == 'SRResnet' or FLAGS.task == 'denoise':
